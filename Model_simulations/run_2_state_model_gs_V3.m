function run_2_state_model_gs_V3
close all;
clear all;
...
norm_factor4=z_hs.xs(end)/z_hs.x(end);
temp_cond_norm = [z_hs.xs./z_hs.x]/norm_factor4;

z_js = sim_2state(f_js, p3);
norm_factor5=z_js.xs(end)/z_js.x(end);
temp_cond_normjs = [z_js.xs./z_js.x]/norm_factor5;
...
plot([50,50],[sudden_cond_norm(50),linear_cond_norm(50)],'o--','linewidth',1,'color',magenta,'markersize',11);
plot([165,165],[sudden_cond_norm(165),log_cond_norm(165)],'x','color',gold_,'markersize',11);
