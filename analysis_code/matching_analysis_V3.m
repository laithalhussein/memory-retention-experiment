...
kstest( (pal_match2_early - mean(pal_match2_early) ) / std(pal_match2_early) )
kstest( (pal_early - mean(pal_early) ) / std(pal_early) )
kstest( (pas_early - mean(pas_early) ) / std(pas_early) )
kstest( (pgl_match1_early - mean(pgl_match1_early) ) / std(pgl_match1_early) )
kstest( (pgl_match2_early- mean(pgl_match2_early) ) / std(pgl_match2_early) )
kstest( (pas_match2_early - mean(pas_match2_early) ) / std(pas_match2_early) )

kstest( (al_match - mean(al_match) ) / std(al_match) )
kstest( (as_match - mean(as_match) ) / std(as_match) )

kstest( (al_match2 - mean(al_match2) ) / std(al_match2) )
kstest( (gl_match1 - mean(gl_match1) ) / std(gl_match1) )

kstest( (as_match2 - mean(as_match2) ) / std(as_match2) )
kstest( (gl_match2 - mean(gl_match2) ) / std(gl_match2) )
