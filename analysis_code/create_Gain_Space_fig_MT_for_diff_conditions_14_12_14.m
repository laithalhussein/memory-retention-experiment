function create_Gain_Space_fig_MT_for_diff_conditions_14_12_14(fig_num,AS_subs,AL_subs,Grad_subs)
...
%% abrupt short
% subjects 
PV_abrupt_short_base_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_short_base_sub,MT_dat_all.velocity_abrupt_short_base_sub,MT_dat_all.position_abrupt_short_base_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AS_subs);
PV_abrupt_short_test_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_short_test_sub,MT_dat_all.velocity_abrupt_short_test_sub,MT_dat_all.position_abrupt_short_test_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AS_subs);
PV_abrupt_short_wash_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_short_wash_sub,MT_dat_all.velocity_abrupt_short_wash_sub,MT_dat_all.position_abrupt_short_wash_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AS_subs);
...
% 
adaptation_abrupt_short_ndx=find((abrupt_short_test_aligned_comp_ave<0.4),1,'last')
...
%% abrupt long  
% subjects 
PV_abrupt_long_base_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_long_base_sub,MT_dat_all.velocity_abrupt_long_base_sub,MT_dat_all.position_abrupt_long_base_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AL_subs);
PV_abrupt_long_test_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_long_test_sub,MT_dat_all.velocity_abrupt_long_test_sub,MT_dat_all.position_abrupt_long_test_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AL_subs);
PV_abrupt_long_wash_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_abrupt_long_wash_sub,MT_dat_all.velocity_abrupt_long_wash_sub,MT_dat_all.position_abrupt_long_wash_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',AL_subs);
...
%
adaptation_abrupt_long_ndx=find((abrupt_long_test_aligned_comp_ave<0.4),1,'last');
...
%% gradual
% subjects 
PV_gradual_base_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_gradual_base_sub,MT_dat_all.velocity_gradual_base_sub,MT_dat_all.position_gradual_base_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',Grad_subs);
PV_gradual_test_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_gradual_test_sub,MT_dat_all.velocity_gradual_test_sub,MT_dat_all.position_gradual_test_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',Grad_subs);
PV_gradual_wash_subjects=calculate_PV_fit_for_subjects_14_12_14(MT_dat_all.force_gradual_wash_sub,MT_dat_all.velocity_gradual_wash_sub,MT_dat_all.position_gradual_wash_sub,MT_info_all,[FF_K,FF_B],'offset_off','dont_initial_zero',Grad_subs);
...
%
adaptation_gradual_ndx=find((gradual_test_aligned_comp_ave<0.4),1,'last');
...
% position
Display_gain_plot_11_07_14([abrupt_short_test_misaligned_comp_ave,abrupt_short_test_aligned_comp_ave],abrupt_short_adapt_color,curve_widith,[-.2,.4,-.2,1.01],'Adaptation');
Display_gain_plot_11_07_14([abrupt_short_wash_misaligned_comp_ave,abrupt_short_wash_aligned_comp_ave],abrupt_short_wash_color,curve_widith,[-.2,.4,-.2,1.01],'Unlearning');
%
daspect([1,1,1])
...
% position
Display_gain_plot_11_07_14([abrupt_long_test_misaligned_comp_ave,abrupt_long_test_aligned_comp_ave],abrupt_long_adapt_color,curve_widith,[-.2,.4,-.2,1.01],'Adaptation');
Display_gain_plot_11_07_14([abrupt_long_wash_misaligned_comp_ave,abrupt_long_wash_aligned_comp_ave],abrupt_long_wash_color,curve_widith,[-.2,.4,-.2,1.01],'Unlearning');
%
daspect([1,1,1])
...
% position
Display_gain_plot_11_07_14([gradual_test_misaligned_comp_ave,gradual_test_aligned_comp_ave],gradual_adapt_color,curve_widith,[-.2,.4,-.2,1.01],'Adaptation');
Display_gain_plot_11_07_14([gradual_wash_misaligned_comp_ave,gradual_wash_aligned_comp_ave],gradual_wash_color,curve_widith,[-.2,.4,-.2,1.01],'Unlearning');
%
daspect([1,1,1])
