function [v_AL,V_GL]=create_AC_fig_multiple_training_for_diff_conditions_14_12_14_LB(fig_num,AS_subs,AL_subs,Grad_subs)
...
Training_sequence={'abrupt short','abrupt long','gradual'};
Training_color_seq=[abrupt_short_adapt_color;abrupt_long_adapt_color;gradual_adapt_color];
plot_bar_with_error_11_07_14(x',fit_late_wash_norm_ave',fit_late_wash_norm_se',Training_sequence,Training_color_seq,zeros(3),h_matrix_fit_late_wash_all_norm);
